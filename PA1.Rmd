...
```
During weekdays the maximum number of steps occurs at interval #`r maxIntervalWeekday` at `r maxHoursWeekday`:`r maxMinutesWeekday` hours.

During weekend the maximum number of steps occurs at interval #`r maxIntervalWeekend` at `r maxHoursWeekend`:`r maxMinutesWeekend` hours.
